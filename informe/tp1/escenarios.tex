...
Luego de dos semanas, \textbf{\emph{Bob}} recibe un email de parte del
...
supera ampliamente el límite estipulado por cliente, aún tras el envío fallido.
...
Leonardo es el Gerente General de 
