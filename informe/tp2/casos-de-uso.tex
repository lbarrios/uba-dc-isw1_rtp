...
Este caso de uso responde al objetivo \textbf{\nameref{para:1.1.1.1.1.1}}. 
...
Este caso de uso se corresponde con el evento \textbf{\ref{itm:f-cliente-autentica-sistema}) el cliente ingresa credenciales en el sistema}, y con el objetivo \textbf{\nameref{para:1.1.1.1.1.2}}, y con sus subobjetivos.
...
El paso 4 se corresponde con los fenómenos \textbf{\ref{itm:f-apilogistica-fechas-libres-sistema}, \ref{itm:f-sistema-fechas-libres-cliente} y \ref{itm:f-cliente-fecha-entrega-sistema}}, y con el objetivo \textbf{\nameref{para:1.1.1.1.3}} y sus subobjetivos.

El paso 5 se corresponde con el evento \textbf{\ref{itm:f-sistema-muestra-metodos-pago-cliente}: sistema presenta los métodos de pago disponibles al cliente} y con los objetivos \textbf{\nameref{para:1.1.1.1.4.1}} y \textbf{lograr [informar métodos de pago disponibles] (1.1.1.1.4.2)}.
